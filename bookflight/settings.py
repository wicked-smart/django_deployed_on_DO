...
#SECRET_KEY = 'django-insecure-cgbk$3t12wq_v7xzp98l4hmuab*x(ei56o@z^))b%1no89nuyh'
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY",get_random_secret_key())

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'djangodeployedondo-production.up.railway.app']
